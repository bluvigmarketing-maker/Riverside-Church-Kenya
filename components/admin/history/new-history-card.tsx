...
export function NewHistoryCard({ action }: { action: (formData: FormData) => Promise<void> }) {
  ...
  return (
    <div className="gold-line rounded-2xl border bg-white p-6">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="font-heading text-lg font-semibold text-navy-950">New Section</h3>
        <button
